...
window.PDF_OVERLAY_CF3 = [
  ...
  { id:'dateAdmittedD1', key:'dateAdmittedD1', page:1, top:25.3, left:16.8,  w:1.9,  fs:8, digit:0, digitKey:'dateAdmitted', digitOrder:'mmddyyyy' },
  { id:'dateAdmittedD2', key:'dateAdmittedD2', page:1, top:25.3, left:18.7,  w:1.9,  fs:8, digit:1, digitKey:'dateAdmitted', digitOrder:'mmddyyyy' },
  { id:'dateAdmittedD3', key:'dateAdmittedD3', page:1, top:25.3, left:23.3,  w:1.9,  fs:8, digit:2, digitKey:'dateAdmitted', digitOrder:'mmddyyyy' },
  { id:'dateAdmittedD4', key:'dateAdmittedD4', page:1, top:25.3, left:25.2,  w:1.9,  fs:8, digit:3, digitKey:'dateAdmitted', digitOrder:'mmddyyyy' },
  { id:'dateAdmittedD5', key:'dateAdmittedD5', page:1, top:25.3, left:29.7,  w:1.88, fs:8, digit:4, digitKey:'dateAdmitted', digitOrder:'mmddyyyy' },
  { id:'dateAdmittedD6', key:'dateAdmittedD6', page:1, top:25.3, left:31.58, w:1.88, fs:8, digit:5, digitKey:'dateAdmitted', digitOrder:'mmddyyyy' },
  { id:'dateAdmittedD7', key:'dateAdmittedD7', page:1, top:25.3, left:33.45, w:1.88, fs:8, digit:6, digitKey:'dateAdmitted', digitOrder:'mmddyyyy' },
  { id:'dateAdmittedD8', key:'dateAdmittedD8', page:1, top:25.3, left:35.33, w:1.88, fs:8, digit:7, digitKey:'dateAdmitted', digitOrder:'mmddyyyy' },
  ...
  { id:'dateDischargeD1', key:'dateDischargeD1', page:1, top:28.5, left:16.8,  w:1.9,  fs:8, digit:0, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dateDischargeD2', key:'dateDischargeD2', page:1, top:28.5, left:18.7,  w:1.9,  fs:8, digit:1, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dateDischargeD3', key:'dateDischargeD3', page:1, top:28.5, left:23.3,  w:1.9,  fs:8, digit:2, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dateDischargeD4', key:'dateDischargeD4', page:1, top:28.5, left:25.2,  w:1.9,  fs:8, digit:3, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dateDischargeD5', key:'dateDischargeD5', page:1, top:28.5, left:29.7,  w:1.88, fs:8, digit:4, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dateDischargeD6', key:'dateDischargeD6', page:1, top:28.5, left:31.58, w:1.88, fs:8, digit:5, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dateDischargeD7', key:'dateDischargeD7', page:1, top:28.5, left:33.45, w:1.88, fs:8, digit:6, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dateDischargeD8', key:'dateDischargeD8', page:1, top:28.5, left:35.33, w:1.88, fs:8, digit:7, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  ...
  { id:'initialPrenatalD1', key:'initialPrenatalD1', page:2, top:8.88, left:31.71, w:1.47,   fs:8, digit:0, digitKey:'initialPrenatalDate', digitOrder:'mmddyyyy' },
  { id:'initialPrenatalD2', key:'initialPrenatalD2', page:2, top:8.88, left:33.18, w:1.47,   fs:8, digit:1, digitKey:'initialPrenatalDate', digitOrder:'mmddyyyy' },
  { id:'initialPrenatalD3', key:'initialPrenatalD3', page:2, top:8.88, left:36.66, w:1.47,   fs:8, digit:2, digitKey:'initialPrenatalDate', digitOrder:'mmddyyyy' },
  { id:'initialPrenatalD4', key:'initialPrenatalD4', page:2, top:8.88, left:38.13, w:1.47,   fs:8, digit:3, digitKey:'initialPrenatalDate', digitOrder:'mmddyyyy' },
  { id:'initialPrenatalD5', key:'initialPrenatalD5', page:2, top:8.88, left:41.6,  w:1.4375, fs:8, digit:4, digitKey:'initialPrenatalDate', digitOrder:'mmddyyyy' },
  { id:'initialPrenatalD6', key:'initialPrenatalD6', page:2, top:8.88, left:43.04, w:1.4375, fs:8, digit:5, digitKey:'initialPrenatalDate', digitOrder:'mmddyyyy' },
  { id:'initialPrenatalD7', key:'initialPrenatalD7', page:2, top:8.88, left:44.48, w:1.4375, fs:8, digit:6, digitKey:'initialPrenatalDate', digitOrder:'mmddyyyy' },
  { id:'initialPrenatalD8', key:'initialPrenatalD8', page:2, top:8.88, left:45.91, w:1.4375, fs:8, digit:7, digitKey:'initialPrenatalDate', digitOrder:'mmddyyyy' },
  ...
  { id:'lmpD1', key:'lmpD1', page:2, top:12.8, left:55.72, w:1.47,   fs:8, digit:0, digitKey:'lmp', digitOrder:'mmddyyyy' },
  { id:'lmpD2', key:'lmpD2', page:2, top:12.8, left:57.19, w:1.47,   fs:8, digit:1, digitKey:'lmp', digitOrder:'mmddyyyy' },
  { id:'lmpD3', key:'lmpD3', page:2, top:12.8, left:60.66, w:1.47,   fs:8, digit:2, digitKey:'lmp', digitOrder:'mmddyyyy' },
  { id:'lmpD4', key:'lmpD4', page:2, top:12.8, left:62.13, w:1.47,   fs:8, digit:3, digitKey:'lmp', digitOrder:'mmddyyyy' },
  { id:'lmpD5', key:'lmpD5', page:2, top:12.8, left:65.6,  w:1.4425, fs:8, digit:4, digitKey:'lmp', digitOrder:'mmddyyyy' },
  { id:'lmpD6', key:'lmpD6', page:2, top:12.8, left:67.04, w:1.4425, fs:8, digit:5, digitKey:'lmp', digitOrder:'mmddyyyy' },
  { id:'lmpD7', key:'lmpD7', page:2, top:12.8, left:68.49, w:1.4425, fs:8, digit:6, digitKey:'lmp', digitOrder:'mmddyyyy' },
  { id:'lmpD8', key:'lmpD8', page:2, top:12.8, left:69.93, w:1.4425, fs:8, digit:7, digitKey:'lmp', digitOrder:'mmddyyyy' },
  ...
  { id:'expectedDDD1', key:'expectedDDD1', page:2, top:32.62, left:65.6,  w:1.47,   fs:8, digit:0, digitKey:'expectedDD', digitOrder:'mmddyyyy' },
  { id:'expectedDDD2', key:'expectedDDD2', page:2, top:32.62, left:67.07, w:1.47,   fs:8, digit:1, digitKey:'expectedDD', digitOrder:'mmddyyyy' },
  { id:'expectedDDD3', key:'expectedDDD3', page:2, top:32.62, left:70.55, w:1.47,   fs:8, digit:2, digitKey:'expectedDD', digitOrder:'mmddyyyy' },
  { id:'expectedDDD4', key:'expectedDDD4', page:2, top:32.62, left:72.02, w:1.47,   fs:8, digit:3, digitKey:'expectedDD', digitOrder:'mmddyyyy' },
  { id:'expectedDDD5', key:'expectedDDD5', page:2, top:32.62, left:75.48, w:1.4425, fs:8, digit:4, digitKey:'expectedDD', digitOrder:'mmddyyyy' },
  { id:'expectedDDD6', key:'expectedDDD6', page:2, top:32.62, left:76.92, w:1.4425, fs:8, digit:5, digitKey:'expectedDD', digitOrder:'mmddyyyy' },
  { id:'expectedDDD7', key:'expectedDDD7', page:2, top:32.62, left:78.37, w:1.4425, fs:8, digit:6, digitKey:'expectedDD', digitOrder:'mmddyyyy' },
  { id:'expectedDDD8', key:'expectedDDD8', page:2, top:32.62, left:79.81, w:1.4425, fs:8, digit:7, digitKey:'expectedDD', digitOrder:'mmddyyyy' },
  ...
  { id:'pncDate2', key:'pncDate2', page:2,
    top:38.16, left:24.53, w:5.07, fs:5 },
  { id:'pncDate3', key:'pncDate3', page:2,
    top:38.16, left:30.88, w:5.07, fs:5 },
  { id:'pncDate4', key:'pncDate4', page:2,
    top:38.16, left:37.24, w:5.07, fs:5 },
  { id:'pncDate5', key:'pncDate5', page:2,
    top:38.16, left:43.59, w:5.07, fs:5 },
  { id:'pncDate6', key:'pncDate6', page:2,
    top:38.16, left:49.95, w:5.07, fs:5 },
  { id:'pncDate7', key:'pncDate7', page:2,
    top:38.16, left:56.31, w:5.07, fs:5 },
  { id:'pncDate8', key:'pncDate8', page:2,
    top:38.16, left:62.66, w:5.07, fs:5 },
  { id:'pncDate9', key:'pncDate9', page:2,
    top:38.16, left:69.02, w:5.07, fs:5 },
  { id:'pncDate10', key:'pncDate10', page:2,
    top:38.16, left:75.38, w:5.07, fs:5 },
  { id:'pncDate11', key:'pncDate11', page:2,
    top:38.16, left:81.72, w:5.07, fs:5 },
  { id:'pncDate12', key:'pncDate12', page:2,
    top:38.16, left:88.07, w:5.07, fs:5 },
  ...
  { id:'deliveryDateD1', key:'deliveryDateD1', page:2, top:52.23, left:31.71, w:1.47,   fs:8, digit:0, digitKey:'deliveryDate', digitOrder:'mmddyyyy' },
  { id:'deliveryDateD2', key:'deliveryDateD2', page:2, top:52.23, left:33.18, w:1.47,   fs:8, digit:1, digitKey:'deliveryDate', digitOrder:'mmddyyyy' },
  { id:'deliveryDateD3', key:'deliveryDateD3', page:2, top:52.23, left:36.66, w:1.47,   fs:8, digit:2, digitKey:'deliveryDate', digitOrder:'mmddyyyy' },
  { id:'deliveryDateD4', key:'deliveryDateD4', page:2, top:52.23, left:38.13, w:1.47,   fs:8, digit:3, digitKey:'deliveryDate', digitOrder:'mmddyyyy' },
  { id:'deliveryDateD5', key:'deliveryDateD5', page:2, top:52.23, left:41.6,  w:1.4375, fs:8, digit:4, digitKey:'deliveryDate', digitOrder:'mmddyyyy' },
  { id:'deliveryDateD6', key:'deliveryDateD6', page:2, top:52.23, left:43.04, w:1.4375, fs:8, digit:5, digitKey:'deliveryDate', digitOrder:'mmddyyyy' },
  { id:'deliveryDateD7', key:'deliveryDateD7', page:2, top:52.23, left:44.48, w:1.4375, fs:8, digit:6, digitKey:'deliveryDate', digitOrder:'mmddyyyy' },
  { id:'deliveryDateD8', key:'deliveryDateD8', page:2, top:52.23, left:45.91, w:1.4375, fs:8, digit:7, digitKey:'deliveryDate', digitOrder:'mmddyyyy' },
  ...
  { id:'postpartumFollowupD1', key:'postpartumFollowupD1', page:2, top:61.75, left:55.01, w:1.47,   fs:8, digit:0, digitKey:'postpartumFollowupDate', digitOrder:'mmddyyyy' },
  { id:'postpartumFollowupD2', key:'postpartumFollowupD2', page:2, top:61.75, left:56.48, w:1.47,   fs:8, digit:1, digitKey:'postpartumFollowupDate', digitOrder:'mmddyyyy' },
  { id:'postpartumFollowupD3', key:'postpartumFollowupD3', page:2, top:61.75, left:59.95, w:1.47,   fs:8, digit:2, digitKey:'postpartumFollowupDate', digitOrder:'mmddyyyy' },
  { id:'postpartumFollowupD4', key:'postpartumFollowupD4', page:2, top:61.75, left:61.42, w:1.47,   fs:8, digit:3, digitKey:'postpartumFollowupDate', digitOrder:'mmddyyyy' },
  { id:'postpartumFollowupD5', key:'postpartumFollowupD5', page:2, top:61.75, left:64.89, w:1.4425, fs:8, digit:4, digitKey:'postpartumFollowupDate', digitOrder:'mmddyyyy' },
  { id:'postpartumFollowupD6', key:'postpartumFollowupD6', page:2, top:61.75, left:66.33, w:1.4425, fs:8, digit:5, digitKey:'postpartumFollowupDate', digitOrder:'mmddyyyy' },
  { id:'postpartumFollowupD7', key:'postpartumFollowupD7', page:2, top:61.75, left:67.78, w:1.4425, fs:8, digit:6, digitKey:'postpartumFollowupDate', digitOrder:'mmddyyyy' },
  { id:'postpartumFollowupD8', key:'postpartumFollowupD8', page:2, top:61.75, left:69.22, w:1.4425, fs:8, digit:7, digitKey:'postpartumFollowupDate', digitOrder:'mmddyyyy' },

  // 12. Date and Time of Discharge (same underlying data as CF3 page 1)
  { id:'dischargeD1_p2', key:'dischargeD1_p2', page:2, top:64.0, left:31.71, w:1.47,   fs:8, digit:0, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dischargeD2_p2', key:'dischargeD2_p2', page:2, top:64.0, left:33.18, w:1.47,   fs:8, digit:1, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dischargeD3_p2', key:'dischargeD3_p2', page:2, top:64.0, left:36.66, w:1.47,   fs:8, digit:2, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dischargeD4_p2', key:'dischargeD4_p2', page:2, top:64.0, left:38.13, w:1.47,   fs:8, digit:3, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dischargeD5_p2', key:'dischargeD5_p2', page:2, top:64.0, left:41.6,  w:1.4375, fs:8, digit:4, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dischargeD6_p2', key:'dischargeD6_p2', page:2, top:64.0, left:43.04, w:1.4375, fs:8, digit:5, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dischargeD7_p2', key:'dischargeD7_p2', page:2, top:64.0, left:44.48, w:1.4375, fs:8, digit:6, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  { id:'dischargeD8_p2', key:'dischargeD8_p2', page:2, top:64.0, left:45.91, w:1.4375, fs:8, digit:7, digitKey:'dateDischarge', digitOrder:'mmddyyyy' },
  ...
  { id:'dateSignedD1', key:'dateSignedD1', page:2, top:87.32, left:58.54, w:1.47,   fs:8, digit:0, digitKey:'dateSigned', digitOrder:'mmddyyyy' },
  { id:'dateSignedD2', key:'dateSignedD2', page:2, top:87.32, left:60.01, w:1.47,   fs:8, digit:1, digitKey:'dateSigned', digitOrder:'mmddyyyy' },
  { id:'dateSignedD3', key:'dateSignedD3', page:2, top:87.32, left:63.48, w:1.47,   fs:8, digit:2, digitKey:'dateSigned', digitOrder:'mmddyyyy' },
  { id:'dateSignedD4', key:'dateSignedD4', page:2, top:87.32, left:64.95, w:1.47,   fs:8, digit:3, digitKey:'dateSigned', digitOrder:'mmddyyyy' },
  { id:'dateSignedD5', key:'dateSignedD5', page:2, top:87.32, left:68.42, w:1.4425, fs:8, digit:4, digitKey:'dateSigned', digitOrder:'mmddyyyy' },
  { id:'dateSignedD6', key:'dateSignedD6', page:2, top:87.32, left:69.86, w:1.4425, fs:8, digit:5, digitKey:'dateSigned', digitOrder:'mmddyyyy' },
  { id:'dateSignedD7', key:'dateSignedD7', page:2, top:87.32, left:71.31, w:1.4425, fs:8, digit:6, digitKey:'dateSigned', digitOrder:'mmddyyyy' },
  { id:'dateSignedD8', key:'dateSignedD8', page:2, top:87.32, left:72.75, w:1.4425, fs:8, digit:7, digitKey:'dateSigned', digitOrder:'mmddyyyy' },
];
